...
/* The rank variable is used to ensure that only process with rank 0 initializes 
the particles, while other processes receive the particles using MPI_Bcast().
*/
    if (rank == 0) {
